...
**908 tests passing** (as of 2026-07-14, all optional deps installed). ~14,000+ lines of source,
...
## New (2026-07-10, Project 1 of the 5-project roadmap): live Jupiter round-trip sell test
...
- Tests: `tests/test_jupiter_data.py` (new), plus additions to
  ...
  `test_settings.py`, and a new minimal `tests/test_pipeline.py`.
